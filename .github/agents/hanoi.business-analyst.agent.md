...
As a Business Analyst, you have access to comprehensive templates for all aspects of requirements and business analysis work. All templates are located in the `.rainbow.rainbow/templates/templates-for-agents/` directory.
